...
| Модуль | Описание | Контексты |
|--------|----------|-----------|
| Dashboard | Основной дашборд с виджетами | Home, Work, Study |
| Tasks | Управление задачами и проектами | Home, Work, Study |
| Calendar | Календарь событий и напоминаний | Home, Work, Study |
| Finance | Личные финансы и бюджет | Home |
| CRM | Управление контактами | Work |
| Notes | Заметки в Markdown | Home, Work, Study |
| Health | Трекер здоровья и привычек | Home |
| Mail | Email клиент с AI | Work |
